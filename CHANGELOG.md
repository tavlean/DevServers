...
- Also: the menu bar count updates when a start or restart fails, not only when it succeeds; the "Restarted" confirmation hides itself after a couple of seconds; and Cloudflare Worker projects show a Wrangler tag in the Start picker.
